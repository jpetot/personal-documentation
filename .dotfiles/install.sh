ln -sf ~/personnal-documentation/.dotfiles/.zshrc ~/.zshrc
ln -sf ~/personnal-documentation/.dotfiles/.gitconfig ~/.gitconfig
ln -sf ~/personnal-documentation/.dotfiles/.gitignore ~/.gitignore
ln -sf ~/personnal-documentation/.dotfiles/.starship.toml ~/.config/starship.toml
